...
public class MediaPlayerDemo_Video extends BaseActivity implements
    ...
    String vid_url = "20190329_123303.mp4";
    File baseUrl = null;
    ...
    public void onCreate(Bundle icicle) {
        ...
        baseUrl = new File(Environment.getExternalStoragePublicDirectory(
    ...
    private void playVideo(Integer Media, String p) {
        doCleanUp();
        try {
            switch (Media) {
                case LOCAL_VIDEO:
