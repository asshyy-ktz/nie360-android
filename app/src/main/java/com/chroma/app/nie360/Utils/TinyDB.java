...
public class TinyDB {
    ...
    public ArrayList<UploadingQueueModel> getUploadingListObject(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<UploadingQueueModel> objects = new ArrayList<UploadingQueueModel>();

        for (String jObjString : objStrings) {
            UploadingQueueModel value = (UploadingQueueModel) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<ProcessingQueueModel> getProcessingListObject(String key, Class<?> mClass) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProcessingQueueModel> objects = new ArrayList<ProcessingQueueModel>();

        for (String jObjString : objStrings) {
            ProcessingQueueModel value = (ProcessingQueueModel) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putUploadingListObject(String key, ArrayList<UploadingQueueModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    public void putProcessingListObject(String key, ArrayList<ProcessingQueueModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Object obj : objArray) {
